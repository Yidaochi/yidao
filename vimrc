...
autocmd BufNewFile *.cpp,*.[ch],*.sh,*.java,*.v exec ":call SetTitle()" 
...
func SetTitle() 
	if &filetype == 'sh' 
		...
		call append(line(".")+2, "#  Author: liuchi") 
		call append(line(".")+3, "#  mail: liuchi@eswin.com") 
		...
		call append(line(".")+1, "	> Author: liuchi") 
		call append(line(".")+2, "	> Mail: liuchi@eswin.com ") 
